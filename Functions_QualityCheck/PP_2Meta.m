...
%% Create Impact Index
    ...
    % Separate Date timestamps.
        Metadata = Data(Data.Index<2,:);
            Date_Time = Metadata.Timestamp(2:2:length(Metadata.Timestamp));

%% Find Voltages
        Metadata_Voltage = Metadata.AccelX(2:2:length(Metadata.AccelX));
